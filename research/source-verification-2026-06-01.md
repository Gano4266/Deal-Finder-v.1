...
| Shuckin' Shack Oyster Bar - Wilmington | https://www.theshuckinshack.com/location-wilmington and https://www.theshuckinshack.com/events/oysters-and-wings-happy-hour | Official Wilmington location page and official event page found. | Phase 1O promoted food-only rows for Monday-Thursday local NC raw oysters, chargrilled oysters, and whole wings. |
...
| Beer Barrio | https://beerbarrionc.com/specials | Official specials page found. | Phase 1O promoted Tuesday `$4` pulled pork tacos with food-only public copy; alcohol-adjacent specials remain suppressed. |
...
| Katy's Grill & Bar | https://katysbarandgrill.com/weekly-specials/ | Official weekly specials page found. | Phase 1P promoted exact breakfast rows for Monday biscuits and gravy, Wednesday breakfast bowl, and Thursday French toast with bacon; lunch/dinner and half-price rows remain held for time/price clarity. |
